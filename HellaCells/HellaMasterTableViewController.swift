...
class HellaMasterTableViewController: UITableViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        for number in 1...100
        {
            numbersForCell.append(number)
        }
        print(numbersForCell)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = String(numbersForCell[indexPath.row])
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)
    {
        ...
        if let unwrappedSend = send?.textLabel?.text
        {
            destinationVC?.labelString = unwrappedSend
        }
